...
from lib.RDF2Vec_Embed import get_rdf2vec_walks
from lib.Label import pre_process_words, URI_parse
from lib.Onto_Projection import Reasoner, OntologyProjection
